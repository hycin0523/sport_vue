  ...
  <div>
    <el-card>
      <el-row :gutter="25">
        ...
        <el-col :span="2">
          <el-button type="primary" @click="addShow" v-has-permission="['ADD_FOOD']">添加食物</el-button>
        </el-col>
      ...
      <!-- 对话框 -->
      <el-dialog :title="title" v-loading="loading" :visible.sync="open" width="60%" @close="dialogClosed">
