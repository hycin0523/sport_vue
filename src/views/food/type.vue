<template>
  <div>
    <el-card>
      ...
      <!-- 对话框 -->
      <el-dialog :title="title" v-loading="loading" :visible.sync="open" width="50%" @close="dialogClose">
...
export default {
  ...
  methods: {
    ...
    deleteById(row) {
      if (row.data.foods.length > 0) return this.$message.warning("请先删除该分类下的食物后操作！");
